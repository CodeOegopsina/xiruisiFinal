...
<script>
    $(function () {
        ...
        $("#search").click(function () {
            location.href = '${pageContext.request.contextPath}/backStage/getOrderList?order_status=0&currentPage=1&pageSizes=10&order_num='+$("#order_num").val()+'&realName='+$("#realName").val()+'';
        })
    })
</script>
<style>
            ...
            <script>
                javaex.page({
                    ...
                    callback : function(rtn) {
                        ...
                        location.href = '${pageContext.request.contextPath}/backStage/getOrderList?order_status=0&currentPage='+rtn.pageNum+'&pageSizes='+rtn.perPageCount+'&order_num='+$("#order_num").val()+'&realName='+$("#realName").val()+'';
                    }
                });
            </script>
        </div>
