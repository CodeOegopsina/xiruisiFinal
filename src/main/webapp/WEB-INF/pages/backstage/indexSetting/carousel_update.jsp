...
<script>
    $(function () {
        $("#save").click(function () {
            ...
            $.ajax({
                url:'${pageContext.request.contextPath}/backStage/carousel_update',
...
<body>
<form id="form">
    <span>图片url</span><input id="image" type="text" class="text" placeholder="请输入图片url" autocomplete="off" value="${carousel.c_img}"/><br>
</form>
